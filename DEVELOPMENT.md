...
## Phase 2 — Spatial Validation + Data-Size Strategy (REVISED SCOPE)

See `PHASE2_SCOPE.md` for full breakdown (revised after Sonnet 5 review). 5 slices:
...
| 2.5 | COG default + integration tests + eval fixtures | ✅ | 2026-07-03 | 519 | `2d36e70` |

Strict sequential: 2.1 → 2.2 → (2.3 ∥ 2.4) → 2.5

Checks 11-14 (band validity, categorical resampling, datum transformation, NoData, pixel alignment) explicitly deferred to Phase 4.

~4 new files, ~13 modified, ~95-100 new/updated tests.
